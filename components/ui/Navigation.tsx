        ...
        {isOpen && (
          <div className="md:hidden fixed inset-0 z-[9999]">
            ...
            <div className={clsx(
              ...
              "bg-black border-l-2 border-cta-brass",
              ...
              <div className="flex items-center justify-between p-6 border-b border-white/20">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <span className="font-serif uppercase tracking-[0.2em] text-sm text-white font-medium">
                    CONSTRUCT
                  </span>
                </div>
                <button
              ...
              <div className="py-8 px-6 space-y-6">
                ...
                <div className="pt-4 border-t border-white/20">
                  <Link
                    href="/contact"
                    onClick={() => setIsOpen(false)}
                    className="block w-full text-center py-3 px-6 bg-cta-brass text-black font-medium rounded-sm hover:bg-cta-brass/90 transition-colors duration-200"
                  >
                    Contact
                  </Link>
                </div>
